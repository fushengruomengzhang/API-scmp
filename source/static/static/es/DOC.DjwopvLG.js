import{_ as m,i as h,a as s,w as I,s as S,x as y,r as l,o as g}from"../js/index.CnJHom6v.js";import"../../public.scmp.config.js";const p=`<div class='title'>NBA-API-使用帮助</div>\r
\r
# 特色\r
\r
## API\r
...
* 支持 RESTFul接口语法\r
* (POST GET)SSE(Server-Sent Events)测试\r
* WebSocket测试\r
* 本地项目接口测试(非本地部署,需要安装插件)\r
* 特殊能力\r
...
* 支持RRULE表达式\r
\r
## 支持DeepSeek AI 能力`,f={},_={urlMapping:f,_is_md:!0,toJSON:()=>p,toString:()=>p,valueOf:()=>p},A=`# 配置信息管理\r
\r
> 该功能是位于侧边栏的齿轮形状的图标\r
\r
## 用户名称配置\r
...
* 选择API\r
    * 使用此菜单后，API树会展示复选框□，勾选想要分享的API后，<br/>\r
      便可使用<span style="color:red">编辑API组合文档</span>菜单或者<span style="color:red">分享已选择的API</span>菜单\r
    * 注:本地存储的API不支出选择,不支持分享,不支持参与API组合文档\r
* 编辑API组合文档\r
...
## 新建/编辑\r
\r
* 可以通过API管理的功能[**_选择API_**],批量选择多个API然后使用[**_编辑API组合文档_**]生成使用文档\r
* 也可以通过API组合文档的[**_新建子文档_**],关联多个API进而生成使用文档\r
* 文档内容支持协同开发\r
\r
## 注意\r
\r
...
# Api Swagger\r
\r
> 对Swagger 文档的解析`,v={},w={urlMapping:v,_is_md:!0,toJSON:()=>A,toString:()=>A,valueOf:()=>A},c=`# 定时任务调度中心\r
\r
> 定时任务调度中心\r
\r
* 支持Cron 表达式,以及RRULE规则表达式`,C={},k={urlMapping:C,_is_md:!0,toJSON:()=>c,toString:()=>c,valueOf:()=>c},P=`# AI 助手\r
\r
* 可以通过 配置信息管理 -> deepseek秘钥配置,配置DeepSeek API 的秘钥\r
* 该秘钥存储在你的本地,绝对安全`,E={},R={urlMapping:E,_is_md:!0,toJSON:()=>P,toString:()=>P,valueOf:()=>P},b={name:"NBA-API-DOC",components:{},setup(){return{}},emits:[],props:{},data(){return{folders:[]}},computed:{el(){return this.$refs.docWrapper.$el},content(){return[_,w,R,k]}},watch:{},created(){},mounted(){},methods:{handleNodeClick(t){const r=this.el.querySelector(`[data-tree-id='${t.uniFlag}']`);r&&r.scrollIntoView({behavior:"smooth"})},onDocChange(){let t=[],r=[],d=0;Array.from(this.el.querySelectorAll("h1,h2,h3,h4,h5,h6")).map((a,i)=>{const n=parseInt(a.tagName.slice(1),10),o=S("dti_");a.setAttribute("data-tree-id",o);const e={id:++d,pid:0,label:a.textContent.trim(),uniFlag:o};for(;r.length&&r[r.length-1].level>=n;)r.pop();r.length>0&&(e.pid=r[r.length-1].id),r.push({...e,level:n}),t.push(e)}),this.folders=y(t,"id","pid")}}},x={class:"nba-api-doc"};function N(t,r,d,a,i,n){const o=l("el-tree"),e=l("s3-scroll"),u=l("s3-doc");return g(),h("div",x,[s(e,{class:"folder"},{default:I(()=>[s(o,{data:i.folders,onNodeClick:n.handleNodeClick},null,8,["data","onNodeClick"])]),_:1}),s(e,null,{default:I(()=>[s(u,{ref:"docWrapper",class:"wrapper_detail",content:n.content,onChange:n.onDocChange},null,8,["content","onChange"])]),_:1})])}const j=m(b,[["render",N],["__scopeId","data-v-329b080e"]]);export{j as default};
