import{s as i}from"../../resources/util/snowflake.util.DJSxTvR5.js";import{h as d}from"../../resources/global/global.util.BxkSm_m5.js";import{_ as I}from"../../components/P3CollaborationMonacoEditor.DfXXNwwM.js";import{c as m,f as s,g as c,r as p,o as u}from"../../vue_runtime.RMvFqZC1.js";import"../../resources/util/machine.code.util.H1Gamunq.js";import"../../resources/util/crypto.util.De05Bpu1.js";import"../../crypto.tqJ8oQci.js";import"../../antlr4.BZgrZd6q.js";import"../../js.By5wATmN.js";import"../../md5.DCeuUgf6.js";import"../../charenc.DHEmDxqN.js";import"../../yjs.4EyWiARc.js";import"../../lib0.Js8wIbJX.js";import"../../stores/base.server.BwcW-qjS.js";import"../../pinia.C6gOBDJN.js";import"../../vue_reactivity.bi65rz2k.js";import"../../vue_shared.Bih7TVPb.js";import"../../resources/util/protobuf.util.Cr4oiYeo.js";import"../../protobufjs.C-CwIaq2.js";import"../../resources/util/map.C-ZMZEqT.js";const h=`<div class='title'>NBA-API-使用帮助</div>
...
> 对Swagger 文档的解析`,y=`# 定时任务调度中心

> 定时任务调度中心

* 支持Cron 表达式,以及RRULE规则表达式`,f={name:"NBA-API-DOC",components:{},setup(){return{}},emits:[],props:{},data(){return{folders:[]}},computed:{el(){return this.$refs.docWrapper.$el},content(){return[h,y]}},watch:{},created(){},mounted(){},methods:{handleNodeClick(a){const n=this.el.querySelector(`[data-tree-id='${a.uniFlag}']`);n&&n.scrollIntoView({behavior:"smooth"})},onDocChange(){let a=[],n=[],l=0;Array.from(this.el.querySelectorAll("h1,h2,h3,h4,h5,h6")).map((o,A)=>{const e=parseInt(o.tagName.slice(1),10),r=i("dti_");o.setAttribute("data-tree-id",r);const t={id:++l,pid:0,label:o.textContent.trim(),uniFlag:r};for(;n.length&&n[n.length-1].level>=e;)n.pop();n.length>0&&(t.pid=n[n.length-1].id),n.push({...t,level:e}),a.push(t)}),this.folders=d(a,"id","pid")}}},S={class:"nba-api-doc"};function g(a,n,l,o,A,e){const r=p("el-tree"),t=p("s3-scroll"),P=p("s3-doc");return u(),m("div",S,[s(t,{class:"folder"},{default:c(()=>[s(r,{data:A.folders,onNodeClick:e.handleNodeClick},null,8,["data","onNodeClick"])]),_:1}),s(t,null,{default:c(()=>[s(P,{ref:"docWrapper",class:"wrapper_detail",content:e.content,onChange:e.onDocChange},null,8,["content","onChange"])]),_:1})])}const G=I(f,[["render",g],["__scopeId","data-v-3fe0bc97"]]);export{G as default};
