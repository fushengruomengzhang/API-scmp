import{_ as A}from"../../../../components/address/S3Address.DkyIjlXU.js";import{a as c,y as n,e,w as d,F as P,r as t,o as I,f as i}from"../../../../vue.BohDCuq1.js";import"../../../../mitt.C1xD_ZTF.js";const m=`<div class='title'>NBA-API-使用帮助</div>
...
> 对Swagger 文档的解析`,u={name:"NBA-API-DOC",components:{},setup(){return{}},emits:[],props:{},data(){return{doc:m}},computed:{},watch:{},created(){},mounted(){},methods:{}},y={class:"back"},h={class:"content"},_={class:"wrapper"};function f(o,a,w,S,s,v){const r=t("el-button"),p=t("el-text"),l=t("s3-doc");return I(),c(P,null,[n("div",y,[e(r,{onClick:a[0]||(a[0]=g=>o.$router.back()),icon:"ArrowLeftBold",text:""}),e(p,{class:"back-title"},{default:d(()=>[i("NBA-API-使用帮助")]),_:1})]),n("div",h,[n("div",_,[e(l,{class:"wrapper_detail",content:s.doc},null,8,["content"])])])],64)}const R=A(u,[["render",f],["__scopeId","data-v-d22e7c78"]]);export{R as default};
