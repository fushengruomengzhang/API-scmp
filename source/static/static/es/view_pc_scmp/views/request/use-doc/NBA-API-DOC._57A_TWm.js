import{_ as A}from"../../../../components/address/S3Address.C-l0MtE3.js";import{a as P,l as n,e,w as d,F as c,r as t,o as I,f as i}from"../../../../vue.B9VI7CMM.js";import"../../../../mitt.C1xD_ZTF.js";const m=`<div class='title'>NBA-API-使用帮助</div>
...
> 对Swagger 文档的解析`,u={name:"NBA-API-DOC",components:{},setup(){return{}},emits:[],props:{},data(){return{doc:m}},computed:{},watch:{},created(){},mounted(){},methods:{}},y={class:"back"},_={class:"content"},f={class:"wrapper"};function h(o,a,w,S,r,v){const s=t("el-button"),p=t("el-text"),l=t("s3-doc");return I(),P(c,null,[n("div",y,[e(s,{onClick:a[0]||(a[0]=g=>o.$router.back()),icon:"ArrowLeftBold",text:""}),e(p,{class:"back-title"},{default:d(()=>[i("NBA-API-使用帮助")]),_:1})]),n("div",_,[n("div",f,[e(l,{class:"wrapper_detail",content:r.doc},null,8,["content"])])])],64)}const C=A(u,[["render",h],["__scopeId","data-v-d22e7c78"]]);export{C as default};
