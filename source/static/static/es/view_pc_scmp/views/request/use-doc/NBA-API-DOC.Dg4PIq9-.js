import{_ as l}from"../../../../components/address/S3Address.BvGSUWFm.js";import{a as P,l as n,e,w as c,F as d,r as t,o as I,f as i}from"../../../../vue.CpRb0aFL.js";const m=`<div class='title'>NBA-API-使用帮助</div>
...
* API 执行结果
    * 展示API测试结果,单次请求的响应结果(ResponseData),响应头(ResponseHeader),多次请求的结果(BatchResponse)
...
* ResponseData: 单次请求结果的返回值
    * 可以通过<span style="color:red">字段描述</span>功能,添加返回值的描述文档信息
* ResponseHeader: 单次请求的响应头信息
* BatchResponse: 执行N次的响应数据展示,内包含{ResponseData,ResponseHeader}
* <span style="color:red">注:</span>如果是下载文件类型的接口,返回值会变成{fileName:"fileName",download:点我下载}.可以通过点击[点我下载]完成文件下载
...
* 即:一组api只能关联一个文档
`,u={name:"NBA-API-DOC",components:{},setup(){return{}},emits:[],props:{},data(){return{doc:m}},computed:{},watch:{},created(){},mounted(){},methods:{}},_={class:"back"},y={class:"content"},f={class:"wrapper"};function h(a,o,w,S,s,v){const r=t("el-button"),p=t("el-text"),A=t("s3-doc");return I(),P(d,null,[n("div",_,[e(r,{onClick:o[0]||(o[0]=x=>a.$router.back()),icon:"ArrowLeftBold",text:""}),e(p,{class:"back-title"},{default:c(()=>[i("NBA-API-使用帮助")]),_:1})]),n("div",y,[n("div",f,[e(A,{class:"wrapper_detail",content:s.doc},null,8,["content"])])])],64)}const E=l(u,[["render",h],["__scopeId","data-v-d22e7c78"]]);export{E as default};
