import{s as i}from"../../../../resources/util/snowflake.util.DJSxTvR5.js";import{l as P}from"../../../../resources/global/global.util.D5S_HlML.js";import{_ as I}from"../../../../components/address/S3Address.Dtr4TMCC.js";import{a as m,e as s,w as d,r as l,o as h}from"../../../../vue.XkSFAW2Q.js";import"../../../../resources/util/machine.code.util.H1Gamunq.js";import"../../../../resources/util/crypto.util.De05Bpu1.js";import"../../../../crypto.tqJ8oQci.js";import"../../../../antlr4.BZgrZd6q.js";import"../../../../js.By5wATmN.js";import"../../../../md5.DCeuUgf6.js";import"../../../../charenc.DHEmDxqN.js";import"../../../../mitt.C1xD_ZTF.js";const u=`<div class='title'>NBA-API-使用帮助</div>
...
* 下拉菜单
    * 预览API: 是一个API文档的概要描述
    * 全局执行次数配置: 对API同时发起N次请求.可以通过[Setting-Config>全局执行次数配置]进行配置
    * 更新API
    * 分享API
        * 该菜单会生成一个API分享路径.
    * 复制路径
...
* Script
    * 功能: 参数格处理的js脚本
    * 提供一个函数,发起请求前会调用这个函数,并给函数传递参数(key, value, path, desc, type, check, reqNum)
    * demo
  \`\`\`js
  /**
   * @param reqNum 第几次请求
   ...
   * @returns {*}
   */
  (reqNum, key, value, path, desc, type, check) => {
...
* 支持Cron 表达式,以及RRULE规则表达式`,y={name:"NBA-API-DOC",components:{},setup(){return{}},emits:[],props:{},data(){return{doc:u,folders:[]}},computed:{el(){return this.$refs.docWrapper.$el}},watch:{},created(){},mounted(){},methods:{handleNodeClick(t){const n=this.el.querySelector(`[data-tree-id='${t.uniFlag}']`);n&&n.scrollIntoView({behavior:"smooth"})},onDocChange(){let t=[],n=[],c=0;Array.from(this.el.querySelectorAll("h1,h2,h3,h4,h5,h6")).map((o,p)=>{const a=parseInt(o.tagName.slice(1),10),r=i("dti_");o.setAttribute("data-tree-id",r);const e={id:++c,pid:0,label:o.textContent.trim(),uniFlag:r};for(;n.length&&n[n.length-1].level>=a;)n.pop();n.length>0&&(e.pid=n[n.length-1].id),n.push({...e,level:a}),t.push(e)}),this.folders=P(t,"id","pid")}}},f={class:"nba-api-doc"};function _(t,n,c,o,p,a){const r=l("el-tree"),e=l("s3-scroll"),A=l("s3-doc");return h(),m("div",f,[s(e,{class:"folder"},{default:d(()=>[s(r,{data:p.folders,onNodeClick:a.handleNodeClick},null,8,["data","onNodeClick"])]),_:1}),s(e,null,{default:d(()=>[s(A,{ref:"docWrapper",class:"wrapper_detail",content:p.doc,onChange:a.onDocChange},null,8,["content","onChange"])]),_:1})])}const j=I(y,[["render",_],["__scopeId","data-v-7565919b"]]);export{j as default};
