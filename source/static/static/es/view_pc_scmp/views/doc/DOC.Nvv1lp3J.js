import{s as d}from"../../../resources/util/snowflake.util.DJSxTvR5.js";import{h as i}from"../../../resources/global/global.util.CfZbHq8L.js";import{_ as I}from"../../../components/address/S3Address.C5UI_yaZ.js";import{a as m,e as s,w as c,r as l,o as u}from"../../../vue_runtime.BlNIPsXe.js";import"../../../resources/util/machine.code.util.H1Gamunq.js";import"../../../resources/util/crypto.util.De05Bpu1.js";import"../../../crypto.tqJ8oQci.js";import"../../../antlr4.BZgrZd6q.js";import"../../../js.By5wATmN.js";import"../../../md5.DCeuUgf6.js";import"../../../charenc.DHEmDxqN.js";import"../../../vue_reactivity.Ce-kYa2s.js";import"../../../vue_shared.CTYdyN8k.js";const h=`<div class='title'>NBA-API-使用帮助</div>
...
* 支持Cron 表达式,以及RRULE规则表达式`,S={name:"NBA-API-DOC",components:{},setup(){return{}},emits:[],props:{},data(){return{folders:[]}},computed:{el(){return this.$refs.docWrapper.$el},content(){return[h,y]}},watch:{},created(){},mounted(){},methods:{handleNodeClick(a){const n=this.el.querySelector(`[data-tree-id='${a.uniFlag}']`);n&&n.scrollIntoView({behavior:"smooth"})},onDocChange(){let a=[],n=[],p=0;Array.from(this.el.querySelectorAll("h1,h2,h3,h4,h5,h6")).map((o,A)=>{const e=parseInt(o.tagName.slice(1),10),r=d("dti_");o.setAttribute("data-tree-id",r);const t={id:++p,pid:0,label:o.textContent.trim(),uniFlag:r};for(;n.length&&n[n.length-1].level>=e;)n.pop();n.length>0&&(t.pid=n[n.length-1].id),n.push({...t,level:e}),a.push(t)}),this.folders=i(a,"id","pid")}}},f={class:"nba-api-doc"};function g(a,n,p,o,A,e){const r=l("el-tree"),t=l("s3-scroll"),P=l("s3-doc");return u(),m("div",f,[s(t,{class:"folder"},{default:c(()=>[s(r,{data:A.folders,onNodeClick:e.handleNodeClick},null,8,["data","onNodeClick"])]),_:1}),s(t,null,{default:c(()=>[s(P,{ref:"docWrapper",class:"wrapper_detail",content:e.content,onChange:e.onDocChange},null,8,["content","onChange"])]),_:1})])}const q=I(S,[["render",g],["__scopeId","data-v-3fe0bc97"]]);export{q as default};
