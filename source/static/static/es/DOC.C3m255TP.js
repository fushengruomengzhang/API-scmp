import{_ as m,i as h,a as s,w as i,s as g,x as S,r as l,o as y}from"../js/index.C99-Ljli.js";import"../../public.scmp.config.js";const A=`<div class='title'>NBA-API-使用帮助</div>
...
## 支持DeepSeek AI 能力`,_={},f={urlMapping:_,_is_md:!0,toJSON:()=>A,toString:()=>A,valueOf:()=>A},p=`# 配置信息管理
...
* Api Detail
    ...
    * FetchCode: 功能辅助输入框.用Fetch请求代码转换成API文档
        * 打开控制台,选择NetWork,找到对应的请求,右键=>Copy=>Copay as fetch,然后粘贴到此处,点击[ToApi]按钮解析
    * ToApi: 按钮,将FetchCode转换成API文档
* Headers
    * 功能: 局部请求头配置
    * 字段: 参数名(请求头名称) 参数值 描述
...
> 对Swagger 文档的解析`,C={},v={urlMapping:C,_is_md:!0,toJSON:()=>p,toString:()=>p,valueOf:()=>p},P=`# 定时任务调度中心

> 定时任务调度中心

* 支持Cron 表达式,以及RRULE规则表达式`,w={},E={urlMapping:w,_is_md:!0,toJSON:()=>P,toString:()=>P,valueOf:()=>P},c=`# AI 助手

* 可以通过AI对话窗口的钥匙图标配置API秘钥信息
* 该秘钥存储在你的本地,**绝对安全**`,R={},k={urlMapping:R,_is_md:!0,toJSON:()=>c,toString:()=>c,valueOf:()=>c},x={name:"NBA-API-DOC",components:{},setup(){return{}},emits:[],props:{},data(){return{folders:[]}},computed:{el(){return this.$refs.docWrapper.$el},content(){return[f,v,k,E]}},watch:{},created(){},mounted(){},methods:{handleNodeClick(a){const n=this.el.querySelector(`[data-tree-id='${a.uniFlag}']`);n&&n.scrollIntoView({behavior:"smooth"})},onDocChange(){let a=[],n=[],I=0;Array.from(this.el.querySelectorAll("h1,h2,h3,h4,h5,h6")).map((o,d)=>{const e=parseInt(o.tagName.slice(1),10),r=g("dti_");o.setAttribute("data-tree-id",r);const t={id:++I,pid:0,label:o.textContent.trim(),uniFlag:r};for(;n.length&&n[n.length-1].level>=e;)n.pop();n.length>0&&(t.pid=n[n.length-1].id),n.push({...t,level:e}),a.push(t)}),this.folders=S(a,"id","pid")}}},N={class:"nba-api-doc"};function T(a,n,I,o,d,e){const r=l("el-tree"),t=l("s3-scroll"),u=l("s3-doc");return y(),h("div",N,[s(t,{class:"folder"},{default:i(()=>[s(r,{data:d.folders,onNodeClick:e.handleNodeClick},null,8,["data","onNodeClick"])]),_:1}),s(t,null,{default:i(()=>[s(u,{ref:"docWrapper",class:"wrapper_detail",content:e.content,onChange:e.onDocChange},null,8,["content","onChange"])]),_:1})])}const B=m(x,[["render",T],["__scopeId","data-v-776cab1d"]]);export{B as default};
