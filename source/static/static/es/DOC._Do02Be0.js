import{_ as m,i as h,a as s,w as c,s as g,x as y,r as l,o as S}from"../js/index.tD-w3AcW.js";import"../../public.scmp.config.js";const A=`<div class='title'>NBA-API-使用帮助</div>
...
`,w={},E={urlMapping:w,_is_md:!0,toJSON:()=>P,toString:()=>P,valueOf:()=>P},d=`# AI 助手

* 可以通过AI对话窗口的钥匙图标配置API秘钥信息
* 该秘钥存储在你的本地,**绝对安全**
`,R={},k={urlMapping:R,_is_md:!0,toJSON:()=>d,toString:()=>d,valueOf:()=>d},T={name:"NBA-API-DOC",components:{},setup(){return{}},emits:[],props:{},data(){return{folders:[]}},computed:{el(){return this.$refs.docWrapper.$el},content(){return[f,v,k,E]}},watch:{},created(){},mounted(){},methods:{handleNodeClick(t){const n=this.el.querySelector(`[data-tree-id='${t.uniFlag}']`);n&&n.scrollIntoView({behavior:"smooth"})},onDocChange(){let t=[],n=[],I=0;Array.from(this.el.querySelectorAll("h1,h2,h3,h4,h5,h6")).map((o,i)=>{const e=parseInt(o.tagName.slice(1),10),r=g("dti_");o.setAttribute("data-tree-id",r);const a={id:++I,pid:0,label:o.textContent.trim(),uniFlag:r};for(;n.length&&n[n.length-1].level>=e;)n.pop();n.length>0&&(a.pid=n[n.length-1].id),n.push({...a,level:e}),t.push(a)}),this.folders=y(t,"id","pid")}}},x={class:"nba-api-doc"};function N(t,n,I,o,i,e){const r=l("el-tree"),a=l("s3-scroll"),u=l("s3-doc");return S(),h("div",x,[s(a,{class:"folder"},{default:c(()=>[s(r,{data:i.folders,onNodeClick:e.handleNodeClick},null,8,["data","onNodeClick"])]),_:1}),s(a,null,{default:c(()=>[s(u,{ref:"docWrapper",class:"wrapper_detail",content:e.content,onChange:e.onDocChange},null,8,["content","onChange"])]),_:1})])}const D=m(T,[["render",N],["__scopeId","data-v-776cab1d"]]);export{D as default};
