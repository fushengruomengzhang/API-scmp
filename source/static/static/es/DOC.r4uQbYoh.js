import{_ as m,i as h,a as s,w as c,s as g,x as S,r as l,o as y}from"../js/index.g2rVsKzj.js";import"../../public.scmp.config.js";const A=`<div class='title'>NBA-API-使用帮助</div>
...
* 该秘钥存储在你的本地,**绝对安全**
`,R={},k={urlMapping:R,_is_md:!0,toJSON:()=>I,toString:()=>I,valueOf:()=>I},x={name:"NBA-API-DOC",components:{},setup(){return{}},emits:[],props:{},data(){return{folders:[]}},computed:{el(){return this.$refs.docWrapper.$el},content(){return[f,v,k,E]}},watch:{},created(){},mounted(){},methods:{handleNodeClick(a){const n=this.el.querySelector(`[data-tree-id='${a.uniFlag}']`);n&&n.scrollIntoView({behavior:"smooth"})},onDocChange(){let a=[],n=[],d=0;Array.from(this.el.querySelectorAll("h1,h2,h3,h4,h5,h6")).map((o,i)=>{const e=parseInt(o.tagName.slice(1),10),r=g("dti_");o.setAttribute("data-tree-id",r);const t={id:++d,pid:0,label:o.textContent.trim(),uniFlag:r};for(;n.length&&n[n.length-1].level>=e;)n.pop();n.length>0&&(t.pid=n[n.length-1].id),n.push({...t,level:e}),a.push(t)}),this.folders=S(a,"id","pid")}}},N={class:"nba-api-doc"};function T(a,n,d,o,i,e){const r=l("el-tree"),t=l("s3-scroll"),u=l("s3-doc");return y(),h("div",N,[s(t,{class:"folder"},{default:c(()=>[s(r,{data:i.folders,onNodeClick:e.handleNodeClick},null,8,["data","onNodeClick"])]),_:1}),s(t,null,{default:c(()=>[s(u,{ref:"docWrapper",class:"wrapper_detail",content:e.content,onChange:e.onDocChange},null,8,["content","onChange"])]),_:1})])}const D=m(x,[["render",T],["__scopeId","data-v-776cab1d"]]);export{D as default};
