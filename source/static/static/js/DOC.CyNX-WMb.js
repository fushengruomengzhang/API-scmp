import{_ as m,s as h,a as y}from"./index.C4r6838e.js";import{i as g,a as s,w as c,r as l,o as S}from"./vendor.Bk-I8i7j.js";import"../../public.scmp.config.js";const p=`<div class='title'>NBA-API-使用帮助</div>
...
## 支持DeepSeek AI 能力
`,_={},f={urlMapping:_,_is_md:!0,toJSON:()=>p,toString:()=>p,valueOf:()=>p},A=`# 配置信息管理
...
> 对Swagger 文档的解析
`,C={},v={urlMapping:C,_is_md:!0,toJSON:()=>A,toString:()=>A,valueOf:()=>A},P=`# 定时任务调度中心
...
* 该秘钥存储在你的本地,**绝对安全**
`,R={},T={urlMapping:R,_is_md:!0,toJSON:()=>i,toString:()=>i,valueOf:()=>i},k={name:"NBA-API-DOC",components:{},setup(){return{}},emits:[],props:{},data(){return{folders:[]}},computed:{el(){return this.$refs.docWrapper.$el},content(){return[f,v,T,E]}},watch:{},created(){},mounted(){},methods:{handleNodeClick(t){const n=this.el.querySelector(`[data-tree-id='${t.uniFlag}']`);n&&n.scrollIntoView({behavior:"smooth"})},onDocChange(){let t=[],n=[],I=0;Array.from(this.el.querySelectorAll("h1,h2,h3,h4,h5,h6")).map((o,d)=>{const e=parseInt(o.tagName.slice(1),10),r=h("dti_");o.setAttribute("data-tree-id",r);const a={id:++I,pid:0,label:o.textContent.trim(),uniFlag:r};for(;n.length&&n[n.length-1].level>=e;)n.pop();n.length>0&&(a.pid=n[n.length-1].id),n.push({...a,level:e}),t.push(a)}),this.folders=y(t,"id","pid")}}},x={class:"nba-api-doc"};function N(t,n,I,o,d,e){const r=l("el-tree"),a=l("s3-scroll"),u=l("s3-doc");return S(),g("div",x,[s(a,{class:"folder"},{default:c(()=>[s(r,{data:d.folders,onNodeClick:e.handleNodeClick},null,8,["data","onNodeClick"])]),_:1}),s(a,null,{default:c(()=>[s(u,{ref:"docWrapper",class:"wrapper_detail",content:e.content,onChange:e.onDocChange},null,8,["content","onChange"])]),_:1})])}const B=m(k,[["render",N],["__scopeId","data-v-776cab1d"]]);export{B as default};
